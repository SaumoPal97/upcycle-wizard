            ...
            <div className="flex space-x-1">
              {[1, 2, 3, 4, 5].map((star) => (
                <button
                  ...
                  className={`p-1 transition-colors bg-transparent hover:bg-transparent border-transparent-0 hover:border-transparent-0 focus:outline-none focus:ring-0 focus:border-none ${
